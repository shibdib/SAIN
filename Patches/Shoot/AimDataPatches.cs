    ...
    internal class AimDataPatches
    {
        ...
        public class AimTimePatch : ModulePatch
        {
            ...
            private static float calcFasterCQB(float distance, float aimTimeResult, SAINAimingSettings aimSettings, StringBuilder stringBuilder)
            {
                ...
                {
                    aimTimeResult = Mathf.Lerp(aimSettings.FasterCQBReactionsMinimum, aimTimeResult, distance / aimSettings.FasterCQBReactionsDistance);
                    stringBuilder?.AppendLine($"Faster CQB Aim Time: Result [{aimTimeResult}] : Original [{aimTimeResult}] : At Distance [{distance}]");
                }
                return aimTimeResult;
            }
        }
